...
extends TextureRegion {
    ...
    public void setAlpha(float a) {
        if (this.color.a != a) {
            this.color.a = a;
            this.vertices[2] = this.packedColor = this.color.toFloatBits();
    ...
    public void setPackedColor(float packedColor) {
        if (packedColor != this.packedColor || packedColor == 0.0f && this.packedColor == 0.0f && Float.floatToIntBits(packedColor) != Float.floatToIntBits(this.packedColor)) {
