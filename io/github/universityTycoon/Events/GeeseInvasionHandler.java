...
public class GeeseInvasionHandler
extends GameEventHandler {
    ...
    public void initialiseEventResponses() {
        this.eventResponses.put(1, new Response(3, "Install deterents."));
        this.eventResponses.put(2, new Response(-5, "Bring in wildlife control experts to safely relocate the geese."));
        this.eventResponses.put(3, new Response(0, "Let them roam free in the university campus."));
    }
