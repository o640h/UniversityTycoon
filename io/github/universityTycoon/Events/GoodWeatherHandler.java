...
public class GoodWeatherHandler
extends GameEventHandler {
    ...
    public void initialiseEventResponses() {
        this.eventResponses.put(1, new Response(3, "Set up outdoor study spaces with shade and seating."));
        this.eventResponses.put(2, new Response(0, "Do nothing."));
        this.eventResponses.put(3, new Response(-3, "Use the good weather to perform overdue outdoor campus maintenance."));
    }
