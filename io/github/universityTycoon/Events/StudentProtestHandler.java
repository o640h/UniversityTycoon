...
public class StudentProtestHandler
extends GameEventHandler {
    ...
    public void initialiseEventResponses() {
        this.eventResponses.put(1, new Response(0, "Hold a meeting with student representatives to understand their concerns and find solutions."));
        this.eventResponses.put(2, new Response(-8, "Disperse the protest and enforce stricter regulations on campus demonstrations."));
        this.eventResponses.put(3, new Response(-4, "Provide temporary solutions to address the immediate issues raised by the protestors."));
    }
